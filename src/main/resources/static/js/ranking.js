...
function render(data) {
    ...
    */
    data.forEach(popularTheme => {
        const name = popularTheme.theme.name;
        const thumbnail = popularTheme.theme.thumbnail;
        const description = popularTheme.theme.description;
